...
func (table *Proposals) FillStruct(tableMap map[string]interface{}) error {
...
func (table *Proposals) Create(tableMap map[string]interface{}) {
...
func (table *Proposals) Update(tableMap map[string]interface{}) {
...
func (table *Proposals) GetByID(tableMap map[string]interface{}, searchParams *SearchParams) {
...
func (table *Proposals) Search(tableMap map[string]interface{}, searchParams *SearchParams) (list []Proposals) {
	if sqlQuery, sqlParams := table.sqlSelect(table, tableMap, searchParams); sqlQuery != "" {
